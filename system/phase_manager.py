...
SCORE_GROUPS: tuple[ScoreGroup, ...] = (
    ...
    ScoreGroup(
        ...
        current_state="The session-aware UX is strong, reopening works, and session comparison plus feedback continuity are now in place, though some deeper interpretive flows still need work.",
    ...
    ScoreGroup(
        ...
        current_state="Sessions are preserved, and explicit feedback memory plus session comparison are now live, though model-improvement loops are still early.",
