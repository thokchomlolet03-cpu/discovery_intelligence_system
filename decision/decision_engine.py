        ...
        top_experiments.append(
            {
                ...
                "raw_predictive_signal": row.get("raw_predictive_signal"),
                "heuristic_policy_score": row.get("heuristic_policy_score"),
                "heuristic_adjustment_delta": row.get("heuristic_adjustment_delta"),
                "raw_signal_weight": row.get("raw_signal_weight"),
                "heuristic_weight": row.get("heuristic_weight"),
                "blended_priority_score": row.get("blended_priority_score"),
                "representation_support_factor": row.get("representation_support_factor"),
                "representation_adjustment": row.get("representation_adjustment"),
                "score_decomposition_summary": row.get("score_decomposition_summary") or "",
                "scoring_failure_mode_summary": row.get("scoring_failure_mode_summary") or "",
