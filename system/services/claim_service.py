    ...
    payload.update(
        {
            ...
            "claim_governed_review_status_summary": review_overlay.get("governed_review_status_summary") or payload.get("claim_governed_review_status_summary"),
            ...
            "claim_derived_governed_review_status_label": review_overlay.get("derived_governed_review_status_label", ""),
            "claim_derived_governed_review_status_summary": review_overlay.get("derived_governed_review_status_summary", ""),
            "claim_derived_governed_review_reason_label": review_overlay.get("derived_governed_review_reason_label", ""),
            "claim_derived_governed_review_reason_summary": review_overlay.get("derived_governed_review_reason_summary", ""),
            "claim_derived_governed_review_history_summary": review_overlay.get("derived_governed_review_history_summary", ""),
            "claim_manual_governed_review_status_label": review_overlay.get("manual_governed_review_status_label", ""),
            "claim_manual_governed_review_status_summary": review_overlay.get("manual_governed_review_status_summary", ""),
            "claim_manual_governed_review_reason_label": review_overlay.get("manual_governed_review_reason_label", ""),
            "claim_manual_governed_review_reason_summary": review_overlay.get("manual_governed_review_reason_summary", ""),
            "claim_manual_governed_review_record_count": review_overlay.get("manual_governed_review_record_count", 0),
            "claim_manual_governed_review_history_summary": review_overlay.get("manual_governed_review_history_summary", ""),
            "claim_manual_governed_review_action_label": review_overlay.get("manual_governed_review_action_label", ""),
            "claim_manual_governed_review_reviewer_label": review_overlay.get("manual_governed_review_reviewer_label", ""),
            "claim_manual_governed_review_note": review_overlay.get("manual_governed_review_note", ""),
            "claim_manual_governed_review_note_summary": review_overlay.get("manual_governed_review_note_summary", ""),
            "claim_manual_governed_review_reopen_revise_summary": review_overlay.get("manual_governed_review_reopen_revise_summary", ""),
            "claim_effective_governed_review_origin_label": review_overlay.get("effective_governed_review_origin_label", ""),
            "claim_effective_governed_review_origin_summary": review_overlay.get("effective_governed_review_origin_summary", ""),
            "claim_effective_governed_review_note": review_overlay.get("effective_governed_review_note", ""),
            "claim_effective_governed_review_note_summary": review_overlay.get("effective_governed_review_note_summary", ""),
            "claim_effective_carryover_effect_summary": review_overlay.get("effective_carryover_effect_summary", ""),
            "claim_governed_review_consistency_label": review_overlay.get("governed_review_consistency_label", ""),
            "claim_governed_review_consistency_summary": review_overlay.get("governed_review_consistency_summary", ""),
        }
    )
    return payload
